...
{
	$message = "<strong>Contact name: $_POST[name],</strong><br />
				<strong>Contact Email ID is :</strong> $_POST[email]<br />
				<strong>Message :-</strong> $_POST[comment]
				";

	sendmail("amanadarsh28@gmail.com","Mail from Appoint My Doctor",$message);
...
function sendmail($toaddress,$subject,$message)
{
	...
	$mail->Username = 'amanadarsh28@gmail.com';                 // SMTP username
	$mail->Password = 'Blindfaith4321@#00';                           // SMTP password
	$mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
	$mail->Port = 587;                                    // TCP port to connect to

	$mail->From = 'amanadarsh38@gmail.com';
	$mail->FromName = 'MyFitnessLog';
	$mail->addAddress($toaddress, 'Joe User');     // Add a recipient
	$mail->addAddress($toaddress);               // Name is optional
	$mail->addReplyTo('amanluvsu007@gmal.com', 'Information');
